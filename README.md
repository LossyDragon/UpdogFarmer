...
Steam Trading Card farmer for Android, originally by [Steev](https://github.com/steevp/UpdogFarmer)

Snapshots - Signed APK builds can be found here:<br>
...
## Note
This fork is a hobby to me, it has no guarantee to be bug free. Issues, suggestions, and PRs are welcome.
...
Some features have been removed to easy the burden of maintaining this app. Idling is the primary focus.
...
- Google has put the old View System into maintenance mode Jun 1 2026
...
- (Soon to be) Rewritten using modern Android features ensuring compatibility for newer devices. 
