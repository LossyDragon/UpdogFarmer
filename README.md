...
Signed APK builds can be found in the *Actions* tab. You must be logged into GitHub to download them. Recommended to choose the first green checkmark for the latest build. 
