...
object PrefsManager {
    ...
    @JvmStatic
    fun getSharedSecret(): String = prefs.getString(SHARED_SECRET, "")!!

    @JvmStatic
    fun getOffline(): Boolean = prefs.getBoolean(OFFLINE, false)

    @JvmStatic
    fun stayAwake(): Boolean {
        return prefs.getBoolean(STAY_AWAKE, false)
    }

    @JvmStatic
    fun minimizeData(): Boolean {
    ...
    @JvmStatic
    fun includeFreeGames(): Boolean {
        return prefs.getBoolean(INCLUDE_FREE_GAMES, false)
    }

    @JvmStatic
    fun useCustomLoginId(): Boolean {
